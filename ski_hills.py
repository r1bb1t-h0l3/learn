# USACO 2014 January Bronze Contest problem Ski Course Design.
...
def cost_for_range(heights, low, high):
    '''
    heights is a list of all hill heights
    low is an integer giving the low end of the range
    high is an integer giving the high end of a range
    
    return the cost of changing all heights 
    of hills to be between low and high
    '''
